...
class Pidie {
  ...
  countries() {
    var data = [
      ...
      { id: 'RU', name: 'Russia', currency_code: 'RUB', currency_name: 'Rub', phone: '', language_code: 'ru', language_name: 'Русский', demonym: 'Moscov' },
      { "id": "UA", "name": "Ukraine", "currency_code": "UAH", "currency_name": "Hrivna", "phone": "+38", "language_code": "ua", "language_name": "Украинский", "demonym": "Ukraine" },
  ...
  flagSelectBox(classId = '') {
    var doubleClass = classId ? `.lang-${classId}` : '';
    ...
    Array.prototype.forEach.call(document.querySelectorAll( doubleClass + ' .pd-languages'), function(elem){
      var addCountry = '';
    ...
    for (var i = 0; i < flagSelect.length; i++) {
      ...
      if (classId) {        
        if (selElmnt.getAttribute('name') != "lang-" + classId) {
          continue;
        }
      }
