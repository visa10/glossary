    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                var flagIcon = "/assets/img/flags/" + country.code.toLowerCase() + ".png";
                console.log(flagIcon)
                countryList += `<option data-country-code="${country.code}" data-tokens="${country.code} ${country.name}" style="background-image: url(${flagIcon}); padding-left:25px; background-position: 4px 7px; background-repeat:no-repeat;" value="${country.name}"> ${country.name} </option> `
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
                ...
                var flagIcon = "assets/img/flags/" + def + ".png";
            ...
            countryInput.eq(i).on('change', function () {
                ...
                flagIcon = "assets/img/flags/" + def + ".png";
                button.css("background-size", '20px');
                button.css("background-position", '10px 9px');
                button.css("padding-left", '40px');
                button.css("background-repeat", 'no-repeat');
